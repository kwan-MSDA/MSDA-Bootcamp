...
+ Here are some details about the [dataset](https://addhealth.cpc.unc.edu/data/#public-use)
    ...
    + The study has followed the same individuals into young adulthood (Wave IV) and beyond (Wave V, Wave VI)
        + Wave I: 1994-1995; Wave II: 1996; Wave III: 2001-2002; Wave IV: 2008-2009; Wave V: 2016-2018; Wave VI: 2022-2025
...
+ The dataset used here is a simulated version of the Add Health dataset
    + 3000 observations and 11 variables

::: notes

+ explanation of the 11 variables in the dataset
    + id: unique identifier for each respondent
    + age: age of respondent at Wave IV
    + gender
    + love: importance of love in a relationship (1-10) 
    + money: importance of money in a relationship (1-10)
    + nocheating: importance of no cheating in a relationship (1-10)
    + debt: debt status (nodebt, lowdebt, highdebt)
    + income: annual income in USD
    + paypercent: percentage of dates paid for by respondent
...
addh5<- addh %>%
  mutate(
    money_or_love = case_when(
      love >= 9 | money >= 9 ~ "extreme",
      love > money ~ "lovegreater",
      love == money ~ "same",
      money > love ~ "moneygreater",
      TRUE ~ NA_character_
    ),
    .after = id
  )
...
sleep_wide2 <- tibble(
  name = c(rep("KT", 2), rep("Wincy", 2), rep("Xiaoyu", 2)),
...
sleep_tidy <- tibble(
  name = c("KT", "Wincy", "Xiaoyu", "Harry", "Haobo"),
  sleep = c(8, 7, 6, 5, 5),
  play = c(2, 2, 3, 3, 2)
)

sleep_tidy2 <- tibble(
  name = c("KT", "Wincy", "Xiaoyu", "Peter", "Susan"),
  study = c(3, 4, 5, 2, 3),
  work = c(8, 10, 9, 6, 5)
)
