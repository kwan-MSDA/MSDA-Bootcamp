...
sleep_wide<- tibble(name=c("KT", "Wincy", "Kelly"),
                    day1=c(8, 7, 6),
                    day2=c(4, 6, 5),
                    day3=c(5, 4, 4),
                    day4=c(7, 7, 6))
...
sleep_wide2<- tibble(name=c(rep("KT",2), rep("Wincy",2), rep("Kelly",2)),
...
sleep_tidy<- tibble(name=c("KT", "Wincy", "Kelly", "May", "Mary"),
                     sleep=c(8, 7, 6, 5, 5),
                     play=c(2, 2, 3, 3, 2))

sleep_tidy2<- tibble(name=c("KT", "Wincy", "Kelly", "Peter", "Susan"),
                      study=c(3, 4, 5, 2, 3),
                      work=c(8, 10, 9, 6, 5))
